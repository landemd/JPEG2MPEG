...
from .models import ImageItem, AudioItem
...
class MediaManager(QObject):
    ...
    def scan_folder_for_images(self, folder):
        """扫描文件夹中的图片"""
    ...
    def _get_image_info(self, image):
        ...
        return (
            ...
            f"修改时间: {image.modified_time.strftime('%Y-%m-%d %H:%M')}"
        )
    ...
    def _get_audio_info(self, audio):
        ...
        return (
            ...
            f"修改时间: {audio.modified_time.strftime('%Y-%m-%d %H:%M')}"
        )